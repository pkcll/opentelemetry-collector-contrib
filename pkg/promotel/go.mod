module github.com/open-telemetry/opentelemetry-collector-contrib/pkg/promotel
...
replace (
	// todo: replace with fork 'go get github.com/pkcll/prometheus@v0.54.1-promotel-protobufparse'
	github.com/prometheus/prometheus v0.54.1 => /Users/pk/repos/external/prometheus
